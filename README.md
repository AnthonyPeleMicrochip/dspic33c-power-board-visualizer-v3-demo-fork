...
This document is intended as a supplement to the user's guide. The user's guide can be found [here](https://www.microchip.com/en-us/software-library/power_board_visualizer). 
...
- [Microchip Code Configurator v5.8.2 or greater](https://www.microchip.com/mplab/mplab-code-configurator)

## Hardware Used

- dsPIC33AK512MPS506 Digital Power PIM, Part-No. [EV42F30A](https://www.microchip.com/EV42F30A)
...
### Programming
1.	Open MPLAB X IPE
2.	Select the device on the DP-PIM: dsPIC33AK512MPS506.
...
o	Target device dsPIC33AK512MPS506 found.
8.	Go to the downloaded Folder of the demo, and select the \Hex File\PBV_V2_demo.X.hex
