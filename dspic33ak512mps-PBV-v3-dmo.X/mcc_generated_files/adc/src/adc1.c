...
void ADC1_Initialize(void)
{
    ...
    //TRG1SRC Software trigger initiated by using ADnSWTRG register; MODE Single sample initiated by TRG1SRC[4:0] trigger; TRG2SRC Triggers are disabled; ACCNUM 4 samples, 13 bits result; SAMC 0.5 TAD; IRQSEL enabled; EIEN disabled; TRG1POL disabled; PINSEL AD1AN3; NINSEL disabled; FRAC Integer; DIFF disabled; 
    AD1CH3CON1 = 0x3200001UL;
    //TRG1SRC Triggers are disabled; MODE Single sample initiated by TRG1SRC[4:0] trigger; TRG2SRC Triggers are disabled; ACCNUM 4 samples, 13 bits result; SAMC 0.5 TAD; IRQSEL enabled; EIEN disabled; TRG1POL disabled; PINSEL AD1AN0; NINSEL disabled; FRAC Integer; DIFF disabled; 
    ...
    // Clearing ADC1_Channel3 interrupt flag.
    IFS5bits.AD1CH3IF = 0U;
    // Enabling ADC1_Channel3 interrupt.
...
void ADC1_PWMTriggerSourceSet(enum ADC1_CHANNEL channel, enum ADC_PWM_INSTANCE pwmInstance, enum ADC_PWM_TRIGGERS triggerNumber)
{
    ...
    {
        case ADC1_Channel3:
                AD1SWTRGbits.CH3TRG = adcTriggerValue;
                break;
        default:
                break;
    }
...
void __attribute__ ( ( __interrupt__ , auto_psv, weak ) ) _AD1CH3Interrupt ( void )
{
