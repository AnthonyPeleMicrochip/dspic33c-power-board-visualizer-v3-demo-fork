...
void PWM_Initialize (void)
{
    // 
    PG1CAP = 0x0UL;
    // BPSEL disabled; AQSS disabled; AQPS disabled; TERM disabled; TSYNCDIS disabled; TQSS disabled; TQPS disabled; LATMOD disabled; SWPCIM disabled; SWPCI disabled; ACP disabled; TERMPS disabled; PPS disabled; PSYNC disabled; SWTERM disabled; BPEN disabled; 
    PG1CLPCI1 = 0x0UL;
    // PSS 0x0; 
    PG1CLPCI2 = 0x0UL;
    ...
    // PHASE 0; 
    PG1PHASE = 0x0UL;
    // BPSEL 0x0; AQSS None; AQPS Not inverted; TERM Manual Terminate; TSYNCDIS PWM EOC; TQSS None; TQPS Not inverted; LATMOD disabled; SWPCIM PCI acceptance logic; SWPCI Drives '0'; ACP Level-sensitive; TERMPS disabled; PPS disabled; PSYNC disabled; SWTERM disabled; BPEN disabled; 
    PG1SPCI1 = 0x0UL;
    // PSS 0x0; 
    PG1SPCI2 = 0x0UL;
